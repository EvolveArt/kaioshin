...
// Kaioshin primitives.
use kp_starknet::block::header::Header as StarknetHeader;
...
pub mod opaque {
	...
	pub type Header = StarknetHeader<BlockNumber, BlakeTwo256>;
	/// Opaque block type.
...
impl frame_system::Config for Runtime {
	...
	/// The header type.
	type Header = StarknetHeader<BlockNumber, BlakeTwo256>;
